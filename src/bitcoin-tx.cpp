...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " leefcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  leefcoin-tx [options] <hex-tx> [commands]  Update hex-encoded leefcoin transaction\n" +
            "or:     leefcoin-tx [options] -create [commands]   Create hex-encoded leefcoin transaction\n" +
            "\n";
