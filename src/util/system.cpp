...
const char * const BITCOIN_CONF_FILENAME = "leefcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LeefCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/LeefCoin";
#else
    // Unix
    return pathRet / ".leefcoin";
#endif
#endif
}
