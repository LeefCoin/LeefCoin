# Support for Output Descriptors in LeefCoin Core

Since LeefCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `lfc1...` for mainnet or `tlfc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on LeefCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing LeefCoin Core wallets, a convenience function `combo` is
