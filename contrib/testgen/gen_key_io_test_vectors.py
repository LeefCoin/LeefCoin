...
bech32_templates = [
  ...
  ('lfc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('lfc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('lfc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tlfc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tlfc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tlfc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rlfc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rlfc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rlfc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tlfc',  17, 32, False, False, False),
  ('rlfc',  3,  1, False, False, False),
  ('lfc',   15, 41, False, False, False),
  ('tlfc',  0, 16, False, False, False),
  ('rlfc',  0, 32, True,  False, False),
  ('lfc',   0, 16, True,  False, False),
  ('tlfc',  0, 32, False, True,  False),
  ('rlfc',  0, 20, False, False, True)
]
