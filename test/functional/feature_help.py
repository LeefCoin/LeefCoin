...
"""Verify that starting leefcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start leefcoin with -h for help text")
        ...
        self.log.info("Start leefcoin with -version for version information")
        ...
        self.log.info("Start leefcoind with -fakearg to make sure it does not start")
